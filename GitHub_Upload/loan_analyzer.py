...
print(f"The total value of loans amounts to: {total_value_of_loans}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = (total_value_of_loans / number_of_loans)
print(f"The average cost of a loan is: {average_loan_amount}.")
...
if present_value >= future_value:
    print(f"The loan is worth the cost to buy")
else:
